...
export const teamMembers: TeamMember[] = [
    ...
    },
  {
    ...
    bio: {
      ...
      pt: 'Engenheiro de software peruano baseado em Buenos Aires, Software Engineer na Vercel Labs, fundador da Crafter Station e principal criador do Petdex.',
      zh: '居住在布宜诺斯艾利斯的秘鲁软件工程师，任职于 Vercel Labs，是 Crafter Station 的创始人和 Petdex 的主要创建者。',
    },
    ...
    projects: ['petdex', 'tinte', 'elements'],
