...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    bio: {
      en: 'Product engineer obsessed with shipping and building in public. Civil engineering dropout turned self-taught software engineer — currently working at a crypto startup. Organizes IRL events to spread the shipping culture across LATAM and is on a mission to grow the Crafter Station community. Co-builder of text0, winner of the Next.js Hackathon 2025. Can help with career advice and shipping products. Also learning to create content — and doing push-ups every single day.',
      es: 'Ingeniero de producto obsesionado con shipear y construir en público. Egresado de ingeniería civil convertido en ingeniero de software autodidacta — actualmente trabajando en una startup de cripto. Organiza eventos IRL para difundir la cultura del shipeo en LATAM y tiene la misión de hacer crecer la comunidad de Crafter Station. Co-creador de text0, ganador del Next.js Hackathon 2025. Puede ayudar con consejos de carrera y shipeo de productos. También aprendiendo a crear contenido — y haciendo flexiones todos los días.',
      'pt-br': 'Engenheiro de produto obcecado em fazer ship e construir em público. Largou engenharia civil para se tornar engenheiro de software autodidata — atualmente trabalhando em uma startup de cripto. Organiza eventos presenciais para espalhar a cultura do ship pelo LATAM e tem a missão de fazer crescer a comunidade da Crafter Station. Co-criador do text0, vencedor do Next.js Hackathon 2025. Pode ajudar com conselhos de carreira e ship de produtos. Também aprendendo a criar conteúdo — e fazendo flexões todos os dias.',
    },
